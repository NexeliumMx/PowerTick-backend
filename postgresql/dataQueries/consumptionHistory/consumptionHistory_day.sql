/*
 * FileName: postgresql/dataQueries/consumptionHistory/consumptionHistory_day.sql
 * Author(s): Arturo Vargas
 * Brief: SQL script for querying energy consumption measurements (Wh/VArh) in the last 24 hours.
 * Date: 2025-02-24
 *
 * Description:
 * This SQL script retrieves the energy consumption measurements (Wh/VArh) for a specific powermeter over the last 24 hours.
 ...
 * 4. Select the energy consumption measurements for the last 24 hours and order them by timestamp in descending order.
 *
 * Example:
