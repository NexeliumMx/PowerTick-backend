/*
 * FileName: postgresql/dataQueries/demandHistory/demandHistory_hour.sql
 * Author(s): Arturo Vargas
 * Brief: SQL script for querying the power demand measurements (W/VAr) in the last hour.
 * Date: 2025-02-24
 *
 * Description:
 * This SQL script retrieves the power demand measurements (in W and VAr) for a specific powermeter over the last hour.
 ...
 * 4. Select the power demand measurements for the last hour and order them by timestamp in descending order.
 *
 * Example:
